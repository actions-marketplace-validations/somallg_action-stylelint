...
echo '::group:: Installing reviewdog 🐶 ... https://github.com/somallg/reviewdog'
curl -sfL https://raw.githubusercontent.com/somallg/reviewdog/master/install.sh | sh -s -- -b "${TEMP_PATH}" "${REVIEWDOG_VERSION}" 2>&1
echo '::endgroup::'
